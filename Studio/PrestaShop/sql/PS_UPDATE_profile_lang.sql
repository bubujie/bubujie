...
-- (1, 1, 'Administrator'),
UPDATE ps_profile_lang SET name='管理员'   WHERE id_lang=1 AND name='Administrator';
-- (1, 2, 'Logistician'),
UPDATE ps_profile_lang SET name='配送员'   WHERE id_lang=1 AND name='Logistician';
-- (1, 3, 'Translator'),
UPDATE ps_profile_lang SET name='翻译员'   WHERE id_lang=1 AND name='Translator';
-- (1, 4, 'Salesman');
UPDATE ps_profile_lang SET name='销售员'   WHERE id_lang=1 AND name='Salesman';
